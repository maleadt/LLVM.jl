...
fence!(builder::Builder, ordering::API.LLVMAtomicOrdering, singleThread::Bool, Name::String="") =
...
cast!(builder::Builder, Op::API.LLVMOpcode, Val::Value, DestTy::LLVMType, Name::String="") =
    Instruction(API.LLVMBuildCast(ref(builder), Op, ref(Val), ref(DestTy)))
...
globalstring!(builder::Builder, Str::String, Name::String="") =
    Instruction(API.LLVMBuildGlobalString(ref(builder), Str, Name))
