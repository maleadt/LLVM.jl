...
function LLVMIsATerminatorInst(Val)
...
function LLVMOrcMakeSharedModule(Mod)
    @apicall(:LLVMOrcMakeSharedModule, LLVMSharedModuleRef, (LLVMModuleRef,), Mod)
end

function LLVMOrcDisposeSharedModuleRef(SharedMod)
...
function LLVMAddBBVectorizePass(PM)
