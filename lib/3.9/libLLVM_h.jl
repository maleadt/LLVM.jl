...
function LLVMAddFunctionAttr(Fn::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMAddFunctionAttr,Cvoid,(LLVMValueRef,LLVMAttribute),Fn,PA)
end
...
function LLVMGetFunctionAttr(Fn::LLVMValueRef)
    @apicall(:LLVMGetFunctionAttr,LLVMAttribute,(LLVMValueRef,),Fn)
end

function LLVMRemoveFunctionAttr(Fn::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMRemoveFunctionAttr,Cvoid,(LLVMValueRef,LLVMAttribute),Fn,PA)
end
...
function LLVMAddAttribute(Arg::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMAddAttribute,Cvoid,(LLVMValueRef,LLVMAttribute),Arg,PA)
end

function LLVMRemoveAttribute(Arg::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMRemoveAttribute,Cvoid,(LLVMValueRef,LLVMAttribute),Arg,PA)
end

function LLVMGetAttribute(Arg::LLVMValueRef)
    @apicall(:LLVMGetAttribute,LLVMAttribute,(LLVMValueRef,),Arg)
end
...
function LLVMAddInstrAttribute(Instr::LLVMValueRef,index::UInt32,arg1::LLVMAttribute)
    @apicall(:LLVMAddInstrAttribute,Cvoid,(LLVMValueRef,UInt32,LLVMAttribute),Instr,index,arg1)
end

function LLVMRemoveInstrAttribute(Instr::LLVMValueRef,index::UInt32,arg1::LLVMAttribute)
    @apicall(:LLVMRemoveInstrAttribute,Cvoid,(LLVMValueRef,UInt32,LLVMAttribute),Instr,index,arg1)
end
...
function LLVMOrcGetSymbolAddress(JITStack::LLVMOrcJITStackRef,SymbolName)
    @apicall(:LLVMOrcGetSymbolAddress,LLVMOrcTargetAddress,(LLVMOrcJITStackRef,Cstring),JITStack,SymbolName)
end
