...
function LLVMAddFunctionAttr(Fn::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMAddFunctionAttr,Void,(LLVMValueRef,LLVMAttribute),Fn,PA)
end
...
function LLVMRemoveFunctionAttr(Fn::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMRemoveFunctionAttr,Void,(LLVMValueRef,LLVMAttribute),Fn,PA)
end
...
function LLVMAddAttribute(Arg::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMAddAttribute,Void,(LLVMValueRef,LLVMAttribute),Arg,PA)
end

function LLVMRemoveAttribute(Arg::LLVMValueRef,PA::LLVMAttribute)
    @apicall(:LLVMRemoveAttribute,Void,(LLVMValueRef,LLVMAttribute),Arg,PA)
end
...
function LLVMAddInstrAttribute(Instr::LLVMValueRef,index::UInt32,arg1::LLVMAttribute)
    @apicall(:LLVMAddInstrAttribute,Void,(LLVMValueRef,UInt32,LLVMAttribute),Instr,index,arg1)
end

function LLVMRemoveInstrAttribute(Instr::LLVMValueRef,index::UInt32,arg1::LLVMAttribute)
    @apicall(:LLVMRemoveInstrAttribute,Void,(LLVMValueRef,UInt32,LLVMAttribute),Instr,index,arg1)
end
