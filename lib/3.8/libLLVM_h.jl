...
function LLVMInitializeAArch64TargetInfo()
    ccall((:LLVMInitializeAArch64TargetInfo,libllvm),Void,())
end

function LLVMInitializeAMDGPUTargetInfo()
    ccall((:LLVMInitializeAMDGPUTargetInfo,libllvm),Void,())
end

function LLVMInitializeARMTargetInfo()
    ccall((:LLVMInitializeARMTargetInfo,libllvm),Void,())
end

function LLVMInitializeBPFTargetInfo()
    ccall((:LLVMInitializeBPFTargetInfo,libllvm),Void,())
end

function LLVMInitializeCppBackendTargetInfo()
    ccall((:LLVMInitializeCppBackendTargetInfo,libllvm),Void,())
end

function LLVMInitializeHexagonTargetInfo()
    ccall((:LLVMInitializeHexagonTargetInfo,libllvm),Void,())
end

function LLVMInitializeMipsTargetInfo()
    ccall((:LLVMInitializeMipsTargetInfo,libllvm),Void,())
end

function LLVMInitializeMSP430TargetInfo()
    ccall((:LLVMInitializeMSP430TargetInfo,libllvm),Void,())
end
...
function LLVMInitializePowerPCTargetInfo()
    ccall((:LLVMInitializePowerPCTargetInfo,libllvm),Void,())
end

function LLVMInitializeSparcTargetInfo()
    ccall((:LLVMInitializeSparcTargetInfo,libllvm),Void,())
end

function LLVMInitializeSystemZTargetInfo()
    ccall((:LLVMInitializeSystemZTargetInfo,libllvm),Void,())
end
...
function LLVMInitializeXCoreTargetInfo()
    ccall((:LLVMInitializeXCoreTargetInfo,libllvm),Void,())
end

function LLVMInitializeAArch64Target()
    ccall((:LLVMInitializeAArch64Target,libllvm),Void,())
end

function LLVMInitializeAMDGPUTarget()
    ccall((:LLVMInitializeAMDGPUTarget,libllvm),Void,())
end

function LLVMInitializeARMTarget()
    ccall((:LLVMInitializeARMTarget,libllvm),Void,())
end

function LLVMInitializeBPFTarget()
    ccall((:LLVMInitializeBPFTarget,libllvm),Void,())
end

function LLVMInitializeCppBackendTarget()
    ccall((:LLVMInitializeCppBackendTarget,libllvm),Void,())
end

function LLVMInitializeHexagonTarget()
    ccall((:LLVMInitializeHexagonTarget,libllvm),Void,())
end

function LLVMInitializeMipsTarget()
    ccall((:LLVMInitializeMipsTarget,libllvm),Void,())
end

function LLVMInitializeMSP430Target()
    ccall((:LLVMInitializeMSP430Target,libllvm),Void,())
end
...
function LLVMInitializePowerPCTarget()
    ccall((:LLVMInitializePowerPCTarget,libllvm),Void,())
end

function LLVMInitializeSparcTarget()
    ccall((:LLVMInitializeSparcTarget,libllvm),Void,())
end

function LLVMInitializeSystemZTarget()
    ccall((:LLVMInitializeSystemZTarget,libllvm),Void,())
end
...
function LLVMInitializeXCoreTarget()
    ccall((:LLVMInitializeXCoreTarget,libllvm),Void,())
end

function LLVMInitializeAArch64TargetMC()
    ccall((:LLVMInitializeAArch64TargetMC,libllvm),Void,())
end

function LLVMInitializeAMDGPUTargetMC()
    ccall((:LLVMInitializeAMDGPUTargetMC,libllvm),Void,())
end

function LLVMInitializeARMTargetMC()
    ccall((:LLVMInitializeARMTargetMC,libllvm),Void,())
end

function LLVMInitializeBPFTargetMC()
    ccall((:LLVMInitializeBPFTargetMC,libllvm),Void,())
end

function LLVMInitializeCppBackendTargetMC()
    ccall((:LLVMInitializeCppBackendTargetMC,libllvm),Void,())
end

function LLVMInitializeHexagonTargetMC()
    ccall((:LLVMInitializeHexagonTargetMC,libllvm),Void,())
end

function LLVMInitializeMipsTargetMC()
    ccall((:LLVMInitializeMipsTargetMC,libllvm),Void,())
end

function LLVMInitializeMSP430TargetMC()
    ccall((:LLVMInitializeMSP430TargetMC,libllvm),Void,())
end
...
function LLVMInitializePowerPCTargetMC()
    ccall((:LLVMInitializePowerPCTargetMC,libllvm),Void,())
end

function LLVMInitializeSparcTargetMC()
    ccall((:LLVMInitializeSparcTargetMC,libllvm),Void,())
end

function LLVMInitializeSystemZTargetMC()
    ccall((:LLVMInitializeSystemZTargetMC,libllvm),Void,())
end
...
function LLVMInitializeXCoreTargetMC()
    ccall((:LLVMInitializeXCoreTargetMC,libllvm),Void,())
end

function LLVMInitializeAArch64AsmPrinter()
    ccall((:LLVMInitializeAArch64AsmPrinter,libllvm),Void,())
end

function LLVMInitializeAMDGPUAsmPrinter()
    ccall((:LLVMInitializeAMDGPUAsmPrinter,libllvm),Void,())
end

function LLVMInitializeARMAsmPrinter()
    ccall((:LLVMInitializeARMAsmPrinter,libllvm),Void,())
end

function LLVMInitializeBPFAsmPrinter()
    ccall((:LLVMInitializeBPFAsmPrinter,libllvm),Void,())
end

function LLVMInitializeHexagonAsmPrinter()
    ccall((:LLVMInitializeHexagonAsmPrinter,libllvm),Void,())
end

function LLVMInitializeMipsAsmPrinter()
    ccall((:LLVMInitializeMipsAsmPrinter,libllvm),Void,())
end

function LLVMInitializeMSP430AsmPrinter()
    ccall((:LLVMInitializeMSP430AsmPrinter,libllvm),Void,())
end
...
function LLVMInitializePowerPCAsmPrinter()
    ccall((:LLVMInitializePowerPCAsmPrinter,libllvm),Void,())
end

function LLVMInitializeSparcAsmPrinter()
    ccall((:LLVMInitializeSparcAsmPrinter,libllvm),Void,())
end

function LLVMInitializeSystemZAsmPrinter()
    ccall((:LLVMInitializeSystemZAsmPrinter,libllvm),Void,())
end
...
function LLVMInitializeXCoreAsmPrinter()
    ccall((:LLVMInitializeXCoreAsmPrinter,libllvm),Void,())
end

function LLVMInitializeAArch64AsmParser()
    ccall((:LLVMInitializeAArch64AsmParser,libllvm),Void,())
end

function LLVMInitializeAMDGPUAsmParser()
    ccall((:LLVMInitializeAMDGPUAsmParser,libllvm),Void,())
end

function LLVMInitializeARMAsmParser()
    ccall((:LLVMInitializeARMAsmParser,libllvm),Void,())
end

function LLVMInitializeHexagonAsmParser()
    ccall((:LLVMInitializeHexagonAsmParser,libllvm),Void,())
end

function LLVMInitializeMipsAsmParser()
    ccall((:LLVMInitializeMipsAsmParser,libllvm),Void,())
end

function LLVMInitializePowerPCAsmParser()
    ccall((:LLVMInitializePowerPCAsmParser,libllvm),Void,())
end

function LLVMInitializeSparcAsmParser()
    ccall((:LLVMInitializeSparcAsmParser,libllvm),Void,())
end

function LLVMInitializeSystemZAsmParser()
    ccall((:LLVMInitializeSystemZAsmParser,libllvm),Void,())
end
...
function LLVMInitializeAArch64Disassembler()
    ccall((:LLVMInitializeAArch64Disassembler,libllvm),Void,())
end

function LLVMInitializeARMDisassembler()
    ccall((:LLVMInitializeARMDisassembler,libllvm),Void,())
end

function LLVMInitializeHexagonDisassembler()
    ccall((:LLVMInitializeHexagonDisassembler,libllvm),Void,())
end

function LLVMInitializeMipsDisassembler()
    ccall((:LLVMInitializeMipsDisassembler,libllvm),Void,())
end

function LLVMInitializePowerPCDisassembler()
    ccall((:LLVMInitializePowerPCDisassembler,libllvm),Void,())
end

function LLVMInitializeSparcDisassembler()
    ccall((:LLVMInitializeSparcDisassembler,libllvm),Void,())
end

function LLVMInitializeSystemZDisassembler()
    ccall((:LLVMInitializeSystemZDisassembler,libllvm),Void,())
end
...
function LLVMInitializeXCoreDisassembler()
    ccall((:LLVMInitializeXCoreDisassembler,libllvm),Void,())
end
...
function LLVMSetDataLayout(M::LLVMModuleRef,Triple)
    ccall((:LLVMSetDataLayout,libllvm),Void,(LLVMModuleRef,Cstring),M,Triple)
end
...
function LLVMGetAsString(c::LLVMValueRef,out)
    ccall((:LLVMGetAsString,libllvm),Cstring,(LLVMValueRef,Ptr{Csize_t}),c,out)
end
...
function LLVMGetMDString(V::LLVMValueRef,Len)
    ccall((:LLVMGetMDString,libllvm),Cstring,(LLVMValueRef,Ptr{UInt32}),V,Len)
end
...
function LLVMLinkModules(Dest::LLVMModuleRef,Src::LLVMModuleRef,Unused::LLVMLinkerMode,OutMessage)
    ccall((:LLVMLinkModules,libllvm),LLVMBool,(LLVMModuleRef,LLVMModuleRef,LLVMLinkerMode,Ptr{Cstring}),Dest,Src,Unused,OutMessage)
end
...
function LLVMOrcCreateIndirectStub(JITStack::LLVMOrcJITStackRef,StubName,InitAddr::LLVMOrcTargetAddress)
    ccall((:LLVMOrcCreateIndirectStub,libllvm),Void,(LLVMOrcJITStackRef,Cstring,LLVMOrcTargetAddress),JITStack,StubName,InitAddr)
end

function LLVMOrcSetIndirectStubPointer(JITStack::LLVMOrcJITStackRef,StubName,NewAddr::LLVMOrcTargetAddress)
    ccall((:LLVMOrcSetIndirectStubPointer,libllvm),Void,(LLVMOrcJITStackRef,Cstring,LLVMOrcTargetAddress),JITStack,StubName,NewAddr)
end
